...
const p = path.join(root, "docs/reference/timetree_poster_ocr/akishibu-poster-ocr-review.json");
...
fs.writeFileSync(path.join(root, "docs/reference/timetree_poster_ocr/akishibu-poster-ocr-SUMMARY.md"), md);
