...
const src = path.join(root, "docs/reference/group_formed_date_suggestions_scenario6.csv");
const out = path.join(root, "docs/reference/group_formed_date_review.csv");
