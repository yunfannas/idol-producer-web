...
import { akishibuLineupChronicleHref, gameManualHref, ikonoijoyBest10Href, languageOptions, lineupChronicleHref, liveTypeLabel, navLabel, oshiChartHref, t, type UiLanguage } from "./i18n";
...
export function renderDesktopShellI18n(p: DesktopShellProps): string {
  ...
  const homeMenuHtml = `<details class="fm-home-dropdown">
    ...
    <div class="fm-home-menu" role="menu">
      ...
      <a class="fm-menu-action fm-menu-link" href="${htmlEsc(akishibuLineupChronicleHref())}" target="_blank" rel="noopener noreferrer" role="menuitem">${htmlEsc(t(lang, "shell_lineup_chronicle_akishibu"))}</a>
