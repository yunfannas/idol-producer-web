...
- `reports/`: generated simulation and analysis outputs
- `tmp/` and `.tmp/`: scratch files, debugging artifacts, and ad hoc testing outputs
- `reference/python-desktop/`: mirrored desktop Python source/reference files used during the web port
