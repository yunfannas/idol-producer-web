# Scenario 6 Japanese Female Idol Tier Calibration — 2025-07-05

Historical market calibration for **Scenario 6 opening date: 2025-07-05**. This file is intentionally separate from the 2026-09 current-market table.

Dimensions use the same standard as the current table:

`Live / Music / Brand -> Overall`

Priority is **Live > Music > Brand**. Overall remains a structural judgment rather than a fixed weighted average. Music combines physical CD sales and streaming. Brand measures group-level scene/industry position, external-work level and public recognition; streaming is not counted again in Brand.

## Scope and evidence policy

- Main table contains only groups judged **Overall C- or above for S6** and still active as of the 2026-09 review.
- Groups that existed at the S6 opening but have since disbanded are excluded from the ranked main table and recorded separately.
...
## S6 active-group calibration — C- or above

| # | Group | Live | Music | Brand | Overall | S6 calibration note |
|---:|---|:---:|:---:|:---:|:---:|---|
| 1 | 乃木坂46 | S | A+ | S | **S** | National top anchor |
| 2 | 櫻坂46 | S- | A | S- | **S-** | Dome/arena-class current product |
| 3 | 日向坂46 | S- | A | S- | **S-** | 2025 opening still materially stronger than the later 2026 profile |
| 4 | =LOVE | A+ | A+ | A | **A+** | Strong arena growth established before later S- breakout |
| 5 | FRUITS ZIPPER | A | A+ | A+ | **A+** | Mainstream breakout already established; Live still below later S- scale |
| 6 | ももいろクローバーZ | A | B+ | A+ | **A** | National legacy brand with large-event Live |
| 7 | AKB48 | B+ | S- | A+ | **A** | Physical Music remains exceptionally strong; Live below historical peak |
| 8 | ≠ME | B+ | A- | B+ | **B+** | Established symbol-series second group |
| 9 | 超ときめき♡宣伝部 | B+ | A- | B+ | **B+** | Mainstream breakout phase |
| 10 | iLiFE! | B | B+ | B | **B** | Strong live-idol growth already established before later arena acceleration |
| 11 | CANDY TUNE | B- | B+ | B | **B** | Music/public breakout ahead of Live |
| 12 | モーニング娘。'25 | B | B | B | **B** | Stable H!P flagship |
| 13 | SKE48 | B | B | B | **B** | Stable regional 48 anchor |
| 14 | NMB48 | B | B | B | **B** | Stable regional 48 anchor; TIF2025 HOT consistent |
| 15 | 私立恵比寿中学 | B | B- | B | **B** | Established large-venue legacy product |
| 16 | HKT48 | B- | B- | B | **B-** | Upper major-idol position |
| 17 | ≒JOY | B- | B | B- | **B-** | Earlier growth stage than 2026 current B |
| 18 | Juice=Juice | C+ | B- | C+ | **C+** | Stable H!P upper-middle anchor |
| 19 | アンジュルム | C+ | C+ | C+ | **C+** | Stable H!P upper-middle anchor |
| 20 | BEYOOOOONDS | C+ | C+ | C+ | **C+** | TIF2025 HOT supports upper-middle position |
| 21 | Appare! | C+ | C- | C | **C+** | Strong festival/own-live structure; IDORISE O-EAST and TIF2025 HOT |
| 22 | 高嶺のなでしこ | C+ | C+ | C+ | **C+** | Strong 2025 major/live-idol bridge |
| 23 | いぎなり東北産 | C+ | C | C+ | **C+** | Strong regional/large-event structure; TIF2025 HOT |
...
| 45 | 衛星とカラテア | C- | D+ | C- | **C-** | IDORISE upper-secondary plus 2025 Zepp/anniversary live structure; active in 2026 |
...
|---|:---:|:---:|:---:|:---:|---|
| ZOCX | C-? | C | C | **C- provisional** | Brand/Music inheritance is real, but ZOCX-era paid-live continuity around the cutoff needs isolation from ZOC history |
| CUTIE STREET | D+ / C-? | A- | B+ | **C- provisional** | Exceptional Music/Brand growth; need to determine whether own Live had crossed the structural C- line by opening |

## D+ upper-boundary research set

D+ groups are **not ranked in the main table**. Only upper-boundary groups are kept because they define the C- survival line and are the most likely promotion/demotion errors.

| Group | Live | Music | Brand | Working Overall | Boundary evidence |
|---|:---:|:---:|:---:|:---:|---|
| UtaGe! | D+ | D+ | C- | **D+** | TIF2025 HEAT/SMILE collaboration and strong circuit presence, but no ordinary independent HOT floor at S6 |
| ドラマチックレコード | D+ | D+ | C- | **D+** | Strong IDORISE/large-festival presence; TIF2025 lower stages rather than HOT |
...
## Dissolved-after-S6 exclusion

Groups that were active at the 2025-07-05 opening but are no longer active at the 2026-09 review are intentionally **not** ranked in the active S6 table.

| Group | S6 status | Exclusion note |
|---|---|---|
| TEAM SHACHI | Would have required C-/C+ range evaluation | Officially announced in February 2025 that the group would disband in December 2025; TIF2025 explicitly treated it as the group's final TIF. Excluded because the project now wants only groups still active today in the S6 comparison table. |

This exclusion list is not assumed complete until the full C-/D+ candidate universe is checked against current activity status.
...
- **Jams Collection** — 8/1, UP-T HOT STAGE, 12:10-12:40 -> consistent with C rather than merely C-.
- **Devil ANTHEM.** — 8/1, UP-T HOT STAGE, 13:30-14:00 -> C- floor.
- **タイトル未定** — 8/1, UP-T HOT STAGE, 16:50-17:20 -> C- floor.
...
2. Check the entire provisional C-/D+ universe for **post-S6 disbandment / permanent activity end**, not merely member graduations or temporary hiatus.
