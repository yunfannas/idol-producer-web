...
| **6** | Latest snapshot | **2025-07-20** | `ROADMAP.md` — “Scenario 6”; `support/docs/scenario6_available_groups.txt`; `database/game_scenarios/scenario_6_2025-07-20/`; preset `database/game_scenarios/test0.json` |
